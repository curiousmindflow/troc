...
async fn one_to_one(
    #[future]
    #[with(
        "/test/best_effort_keep_all_volatile/one_to_one",
        ReliabilityQosPolicy::BestEffort,
        HistoryQosPolicy::KeepAll,
        DurabilityQosPolicy::Volatile
    )]
...
async fn test_many_writers_single_reader(
    #[future]
    #[with(
        "/test/best_effort_keep_all_volatile/test_many_writers_single_reader",
        3,
        ReliabilityQosPolicy::BestEffort,
        HistoryQosPolicy::KeepAll,
        DurabilityQosPolicy::Volatile
...
async fn test_many_readers_single_writer(
    #[future]
    #[with(
        "/test/best_effort_keep_all_volatile/test_many_readers_single_writer",
        3,
        ReliabilityQosPolicy::BestEffort,
        HistoryQosPolicy::KeepAll,
        DurabilityQosPolicy::Volatile
...
async fn test_mesh(
    #[future]
    #[with(
        "/test/best_effort_keep_all_volatile/test_mesh",
        ReliabilityQosPolicy::BestEffort,
        HistoryQosPolicy::KeepAll,
        DurabilityQosPolicy::Volatile
    )]
