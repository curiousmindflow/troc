...
async fn one_to_one(
    #[future]
    #[with("/test/best_effort_keep_last_volatile/one_to_one", ReliabilityQosPolicy::BestEffort, HistoryQosPolicy::KeepLast { depth: 1 }, DurabilityQosPolicy::Volatile)]
    custom_two_participants: (DataReader<DummyStruct>, DataWriter<DummyStruct>),
) {
...
async fn test_many_writers_single_reader(
    #[future]
    #[with("/test/best_effort_keep_last_volatile/test_many_writers_single_reader", 3, ReliabilityQosPolicy::BestEffort, HistoryQosPolicy::KeepLast { depth: 1 }, DurabilityQosPolicy::Volatile)]
...
async fn test_many_readers_single_writer(
    #[future]
    #[with("/test/best_effort_keep_last_volatile/test_many_readers_single_writer", 3, ReliabilityQosPolicy::BestEffort, HistoryQosPolicy::KeepLast { depth: 1 }, DurabilityQosPolicy::Volatile)]
    multiple_readers_single_writer: (
...
async fn test_mesh(
    #[future]
    #[with("/test/best_effort_keep_last_volatile/test_mesh", ReliabilityQosPolicy::BestEffort, HistoryQosPolicy::KeepLast { depth: 1 }, DurabilityQosPolicy::Volatile)]
    mesh: (
