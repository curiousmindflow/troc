...
#[tokio::test]
async fn one_to_one(
    #[future]#[with("/test/reliable_keep_last_transient_local/one_to_one", ReliabilityQosPolicy::Reliable { max_blocking_time: Timestamp::default() }, HistoryQosPolicy::KeepLast { depth: 1 }, DurabilityQosPolicy::TransientLocal)] custom_two_participants: (DataReader<DummyStruct>, DataWriter<DummyStruct>),
) {
...
#[tokio::test]
async fn test_mesh(
    #[future] #[with("/test/reliable_keep_last_transient_local/test_mesh", ReliabilityQosPolicy::Reliable { max_blocking_time: Timestamp::default() }, HistoryQosPolicy::KeepLast { depth: 1 }, DurabilityQosPolicy::TransientLocal)] mesh: (Vec<(i32, i32, DataWriter<DummyStruct>)>, Vec<(i32, i32, DataReader<DummyStruct>)>),
) {
