...
impl ReaderBuilder {
    pub fn new(guid: Guid, qos: InlineQos, config: ReaderConfiguration) -> Self {
        Self {
            guid,
            qos,
...
mod tests {
    ...
    use super::{Reader, ReaderBuilder, ReaderConfiguration};
    ...
    fn setup_reader(
        ...
        let mut reader = ReaderBuilder::new(Guid::default(), qos, ReaderConfiguration::default())
            .reliable(reliable)
            .build();
